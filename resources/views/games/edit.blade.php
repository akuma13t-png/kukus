...
@section('content')
<div class="min-h-screen bg-[#1b2838] py-12 text-white">
    <div class="max-w-3xl mx-auto px-4">
        
        <div class="bg-[#16202d] border-t-4 border-[#66c0f4] shadow-2xl p-8">
            <h1 class="text-3xl font-light text-white mb-8 uppercase tracking-wider">Edit Game: <span class="font-bold text-[#66c0f4]">{{ $game->title }}</span></h1>
            ...
            <form action="{{ route('game.update', $game) }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-2 gap-6">
                    <div>
                        ...
                        <select name="genre" class="w-full bg-[#2a3f5a] text-white border border-[#000] p-3">
                    ...
                    <div>
                        ...
                        <input type="number" name="price" value="{{ $game->price }}" class="w-full bg-[#2a3f5a] text-white border border-[#000] p-3">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <textarea name="description" rows="6" class="w-full bg-[#2a3f5a] text-white border border-[#000] p-3">{{ $game->description }}</textarea>
                </div>
                ...
                <div class="flex justify-end gap-4 pt-6 border-t border-gray-700">
                    ...
                    <button type="submit" class="bg-[#66c0f4] hover:bg-[#419ec0] text-black px-8 py-3 font-bold uppercase text-sm shadow-lg hover:translate-y-[-2px] transition">
                        Save Changes
                    </button>
                </div>
